    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.GET, "/api/admin/jobs").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/admin/operation-logs").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/admin/users").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PATCH, "/api/admin/users/*/status").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/api/statistics/overview").hasAnyRole("HR", "ADMIN")
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/interviews/*").hasAnyRole("HR", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/interviews/me").hasRole("CANDIDATE")
                .requestMatchers(HttpMethod.GET, "/api/jobs/*/interviews").hasAnyRole("HR", "ADMIN")
