...
Capture these screenshots after importing `sql/002_seed_demo_data.sql` and running the backend:

1. `01-swagger-home.png`
   Swagger UI homepage with grouped endpoints.
...
- Keep names stable so they can be referenced from README or future PR descriptions.
