...
- 独立 `frontend/` React 应用已接入公共岗位、候选人和 HR 主流程
...
- 公共岗位浏览与筛选
- 选中岗位详情卡与跨面板工作上下文
- 候选人快捷登录、简历上传、投递、查看申请/面试/通知
- HR 快捷登录/退出、创建岗位、更新/删除自己岗位、查看投递、推进状态、安排或更新面试
- Admin 快捷登录/退出、查看统计、筛选岗位并做状态切换、筛选用户、管理用户、筛选操作日志
- 同源调用后端 API，无需额外前端服务
